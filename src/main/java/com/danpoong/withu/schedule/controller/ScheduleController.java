...
public class ScheduleController {
  ...
  public ResponseEntity<ScheduleResponseDto> addSchedule(
    ...
    ScheduleResponseDto scheduleResponse =
        scheduleService.addSchedule(userId, familyId, title, memo, date, authorName);
  ...
  public ResponseEntity<ScheduleResponseDto> updateSchedule(
    ...
    ScheduleResponseDto updatedScheduleResponse =
        scheduleService.updateSchedule(scheduleId, userId, title, memo, date);
  ...
  public ResponseEntity<ScheduleResponseDto> getScheduleById(
      @RequestHeader("Authorization") String bearerToken, @PathVariable Long scheduleId) {

    Long userId = extractUserId(bearerToken); // 토큰에서 userId 추출
    ScheduleResponseDto scheduleDto =
        scheduleService.findScheduleByUserAndFamily(userId, scheduleId);
  ...
  public ResponseEntity<List<ScheduleResponseDto>> getAllSchedules(
    ...
    List<ScheduleResponseDto> schedules =
        scheduleService.findSchedulesByUserOrFamily(userId, familyId);
