...
public class UserStatusController {
  ...
  public ResponseEntity<UserStatusResponseDto> createMemo(
      @RequestHeader("Authorization") String bearerToken, @RequestParam String text) {
  ...
  public ResponseEntity<List<UserStatusResponseDto>> getFamilyMemberStatuses(
    ...
    try {
      ...
      List<UserStatusResponseDto> responseDtos =
          familyStatuses.stream().map(UserStatusResponseDto::new).toList();
