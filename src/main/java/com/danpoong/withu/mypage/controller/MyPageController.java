...
public class MyPageController {
  ...
  public ResponseEntity<Integer> getReceivedLetters(
  ...
  public ResponseEntity<Integer> getSentLetters(
      @RequestHeader("Authorization") String bearerToken) {
    Long userId = extractUserId(bearerToken);
  ...
  public ResponseEntity<String> updateNickname(
      @RequestHeader("Authorization") String bearerToken, @RequestParam String newNickname) {
    Long userId = extractUserId(bearerToken);
  ...
  public ResponseEntity<String> updateBirthdate(
      @RequestHeader("Authorization") String bearerToken, @RequestParam LocalDate birthdate) {
    Long userId = extractUserId(bearerToken);
